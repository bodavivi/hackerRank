...
class StrongPasswordTest {
  ...
  void minimumNumber_should_return_1_if_password_is_5_character_long() {
    ...
    Assertions.assertEquals(1, StrongPassword.minimumNumber(password.length(), password));
  }
  ...
  void minimumNumber_should_return_2_if_password_is_doesnt_have_a_digit_and_a_lowercase_letter() {
    ...
    Assertions.assertEquals(2, StrongPassword.minimumNumber(password.length(), password));
  }
  ...
  void minimumNumber_should_return_0_if_password_meets_the_criteria(){
    ...
    Assertions.assertEquals(0, StrongPassword.minimumNumber(password.length(), password));
  }
  ...
  void minimumNumber_should_return_4_if_password_has_6_characters_but_didnt_meet_the_other_criterias(){
    ...
    Assertions.assertEquals(4, StrongPassword.minimumNumber(password.length(), password));
  }


  @Test
  void minimumNumber_should_return_1(){
